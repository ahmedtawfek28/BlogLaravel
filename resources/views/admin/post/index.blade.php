                     ...
                     @else 
                      ...
                      @endif
						...
						@if ($Post->is_approved==false)
                            ...
                            <button class="btn btn-success" data-myid={{$Post->id}} data-toggle="modal" data-target="#approval"><i class="fa  fa-check"></i></button>
                            
                         @else 
                         <button class="btn btn-info" data-myid={{$Post->id}} data-toggle="modal" data-target="#approval"><i class="ti-close"></i></button>
...
@endsection
@section('model')
@include('admin.post.model')
@endsection
@section('ajax')
@include('admin.post.ajax')
@endsection