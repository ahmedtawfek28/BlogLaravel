...
$('#show').on('show.bs.modal', function (event) {
      ...
      var ptitle_en = button.data('myptitle_en')
      var ptitle_ar = button.data('myptitle_ar')
      ...
      var modal = $(this)
      document.getElementById('imageBox').src ="http://127.0.0.1:8000/app/public/childcategory/"+image;
      document.getElementById('imageBox0').src ="http://127.0.0.1:8000/app/public/childcategory/"+image;
      modal.find('.modal-body #ptitle_en').val(ptitle_en);
      modal.find('.modal-body #ptitle_ar').val(ptitle_ar);
