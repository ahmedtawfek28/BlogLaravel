        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    ...
                    <h3 class="text-themecolor">childcategory </h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="../dashboard">Home</a></li>
                            <li class="breadcrumb-item ">childcategory</li>
        ...
        <form action="{{ route('admin.childcategory.update',$childcategory->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title_ar" id="title_ar" value="{{ $childcategory->title_ar }}">
                                </div>
                                <div class="form-group">
                                    <label for="title_en">Title_en</label>
                                    <input type="text" class="form-control" name="title_en" id="title_en" value="{{ $childcategory->title_en }}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="parentcategories" id="parentcategory" class="select2 m-b-10 " style="width: 100%" >
                                         ...
                                         <option {{ $ParentCategory->id == $childcategory->parent_category_id ? 'selected' : '' }} value="{{$ParentCategory->id}}">{{$ParentCategory->title_en}}</option>
                                          @endforeach
				...
				<div class="details_ar">
					...
					<textarea id="mymce" name="details_ar" >{{ $childcategory->details_ar }}</textarea>
					</div>
<br>
<br>
                    <div class="details_en">
                    <label for="details_en">Details_En</label>
					<textarea id="mymce" name="details_en" >{{ $childcategory->details_en }}</textarea>
                    </div>
					</div>
                    </div>
					</div>
