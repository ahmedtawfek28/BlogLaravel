                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content tabcontent-border">
                                        <div class="tab-pane active" id="En" role="tabpanel">
                                            <div class="p-20">
											   <label for="ptitle_en">parent_categorytitle_en</label>
	        	                            	<input type="text" class="form-control" name="ptitle_en" id="ptitle_en" disabled>
										...
										<div class="tab-pane" id="Ar" role="tabpanel">
                                            <div class="p-20">
											<label for="ptitle_ar">parent_categorytitle_ar</label>
	        	                            	<input type="text" class="form-control" name="ptitle_ar" id="ptitle_ar" disabled>
