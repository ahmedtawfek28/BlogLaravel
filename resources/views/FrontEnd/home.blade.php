...
<body>
    ...
    <div class="instargram_area owl-carousel section_padding_100_0 clearfix" id="portfolio">
        ...
        <div class="instagram_gallery_item">
            <!-- Instagram Thumb -->
            <img src="{{ Storage::disk('public')->url('category/slider/'.$category->image) }}" alt="{{ $category->title }}">
            <!-- Hover -->
            <div class="hover_overlay">
                <div class="yummy-table">
                    <div class="yummy-table-cell">
                        <div class="follow-me text-center">
                            <a href="#"><i class="fa  fa-link " aria-hidden="true"></i> {{$category->title}} ({{$category->posts->count()}})</a>
                        </div>
                    </div>
                </div>
            </div>
                                                        ...
                                                        <div class="post-content">
                                                            <div class="post-meta d-flex">
                                                                <div class="post-author-date-area d-flex">
                                                                    ...
                                                                    <!-- Post Date -->
                                                                    <div class="post-date">
                                                                        <a href="#">{{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $post->updated_at)->diffForHumans() }}</a>
                                                                    </div>
                                                                </div>
                                                                        ...
                                                                        <div class="post-favourite">
                                                                                @guest
                                                                                    <a href="javascript:void(0);" onclick="toastr.info('To add favorite list. You need to login first.','Info',{
                                                                                        closeButton: true,
                                                                                        progressBar: true,
                                                                                    })"><i class="fa fa-heart-o" aria-hidden="true"></i> {{ $post->favorite_to_users->count() }}</a>
                                                                                @else
                    ...
                    <div class="blog-sidebar mt-5 mt-lg-0">
                        ...
                        <div class="single-widget-area about-me-widget text-center">
                            ...
                            <div class="about-me-widget-thumb">
                                <img src="{{asset('FrontEnd/img/about-img/1.jpg')}}" alt="">
                            </div>
                        ...
                        <div class="single-widget-area popular-post-widget">
                            ...
                            <div class="single-populer-post d-flex">
                                <img src="{{asset('FrontEnd/img/sidebar-img/1.jpg')}}" alt="">
                                <div class="post-content">
                                    <a href="#">
                            ...
                            <!-- Single Popular Post -->
                            <div class="single-populer-post d-flex">
                                <img src="{{asset('FrontEnd/img/sidebar-img/2.jpg')}}" alt="">
                                <div class="post-content">
                                    <a href="#">
                            ...
                            <!-- Single Popular Post -->
                            <div class="single-populer-post d-flex">
                                <img src="{{asset('FrontEnd/img/sidebar-img/3.jpg')}}" alt="">
                                <div class="post-content">
                                    <a href="#">
                            ...
                            <!-- Single Popular Post -->
                            <div class="single-populer-post d-flex">
                                <img src="{{asset('FrontEnd/img/sidebar-img/4.jpg')}}" alt="">
                                <div class="post-content">
                                    <a href="#">
                            ...
                            <!-- Single Popular Post -->
                            <div class="single-populer-post d-flex">
                                <img src="{{asset('FrontEnd/img/sidebar-img/5.jpg')}}" alt="">
                                <div class="post-content">
                                    <a href="#">
                        ...
                        <div class="single-widget-area add-widget text-center">
                            <div class="add-widget-area">
                                <img src="{{asset('FrontEnd/img/sidebar-img/6.jpg')}}" alt="">
                                <div class="add-text">
                                    <div class="yummy-table">
                                        <div class="yummy-table-cell">
                                            <h2>Cooking Book</h2>
                        ...
                        <div class="single-widget-area newsletter-widget">
                            ...
                            <p>Subscibe Us for latest news </p>
