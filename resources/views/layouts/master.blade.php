...
<head>
    ...
    <link href="{{asset('BackEnd/main/css/colors/default.css')}}" id="theme" rel="stylesheet">
    <link rel="stylesheet" href="http://cdn.bootcss.com/toastr.js/latest/css/toastr.min.css">
        ...
        <link href="{{asset('BackEnd/main/css/pages/form-icheck.css')}}" rel="stylesheet">
...
<body class="fix-header card-no-border fix-sidebar">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown u-pro">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{ Storage::disk('public')->url('profile/'.Auth::user()->image) }}" alt="user" class="" /> <span class="hidden-md-down">{{Auth::user()->name}} &nbsp;<i class="fa fa-angle-down"></i></span> </a>
                            <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            <div class="u-img"><img src="{{ Storage::disk('public')->url('profile/'.Auth::user()->image) }}" alt="user"></div>
                                            <div class="u-text">
                                                <h4>{{Auth::user()->name}}</h4>
                                                <p class="text-muted">{{Auth::user()->email}}</p><a href="{{route('admin.settings')}}" class="btn btn-rounded btn-danger btn-sm">View Profile</a></div>
                                        </div>
                                    </li>
                                    <li role="separator" class="divider"></li>
                                    <li><a href="{{route('admin.settings')}}"><i class="ti-user"></i> My Profile</a></li>
    ...
    <script src="{{asset('BackEnd/assets/node_modules/bootstrap/js/popper.min.js')}}"></script>
    <script src="{{asset('BackEnd/assets/node_modules/bootstrap/js/bootstrap.min.js')}}"></script>
    <!-- slimscrollbar scrollbar JavaScript -->
    <script src="{{asset('BackEnd/assets/node_modules/ps/perfect-scrollbar.jquery.min.js')}}"></script>
    <!--Wave Effects -->
    <script src="{{asset('BackEnd/main/js/waves.js')}}"></script>
    <!--Menu sidebar -->
    <script src="{{asset('BackEnd/main/js/sidebarmenu.js')}}"></script>
    <!--stickey kit -->
    ...
    <!-- Style switcher -->
    <!-- ============================================================== -->
    <script src="{{asset('BackEnd/assets/node_modules/styleswitcher/jQuery.style.switcher.js')}}"></script>
